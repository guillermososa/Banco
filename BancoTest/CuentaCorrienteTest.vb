...
Module CuentaCorrienteTest
    Sub Main()
        ...
        Dim cuenta1 As New CuentaCorriente(432432, 1000, New Cliente("Juan", 7797987, #5-12-1990#))
        ...
        cuenta2 = New CuentaCorriente(54354, 1000, New Cliente("Juan", 7797987, #5-12-1990#))
        monto = 900
